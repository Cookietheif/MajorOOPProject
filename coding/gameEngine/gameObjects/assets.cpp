...
carrot_seed_bordered_texture.loadFromFile("coding/gameEngine/gameObjects/assets/carrot_seed_bordered.png");
carrot_seed_bordered_sprite.setTexture(carrot_seed_bordered_texture);
carrot_seed_bordered_sprite.setScale(5.f,5.f);

carrot_seed_texture.loadFromFile("coding/gameEngine/gameObjects/assets/carrot_seed.png");
carrot_seed_sprite.setTexture(carrot_seed_texture);
carrot_seed_sprite.setScale(5.f,5.f);

carrot_tile_grown_texture.loadFromFile("coding/gameEngine/gameObjects/assets/carrot_tile_grown.png");
carrot_tile_grown_sprite.setTexture(carrot_tile_grown_texture);
carrot_tile_grown_sprite.setScale(5.f,5.f);

carrot_tile_texture.loadFromFile("coding/gameEngine/gameObjects/assets/carrot_tile.png");
carrot_tile_sprite.setTexture(carrot_tile_texture);
carrot_tile_sprite.setScale(5.f,5.f);

chicken_bordered_texture.loadFromFile("coding/gameEngine/gameObjects/assets/chicken_bordered.png");
chicken_bordered_sprite.setTexture(chicken_bordered_texture);
chicken_bordered_sprite.setScale(5.f,5.f);

chicken_harvestable_texture.loadFromFile("coding/gameEngine/gameObjects/assets/chicken_harvestable.png");
chicken_harvestable_sprite.setTexture(chicken_harvestable_texture);
chicken_harvestable_sprite.setScale(5.f,5.f);

chicken_tile_texture.loadFromFile("coding/gameEngine/gameObjects/assets/chicken_tile.png");
chicken_tile_sprite.setTexture(chicken_tile_texture);
chicken_tile_sprite.setScale(5.f,5.f);

chicken_texture.loadFromFile("coding/gameEngine/gameObjects/assets/chicken.png");
chicken_sprite.setTexture(chicken_texture);

coin_texture.loadFromFile("coding/gameEngine/gameObjects/assets/coin.png");
coin_sprite.setTexture(coin_texture);
coin_sprite.setScale(5.f,5.f);

cow_bordered_texture.loadFromFile("coding/gameEngine/gameObjects/assets/cow_bordered.png");
cow_bordered_sprite.setTexture(cow_bordered_texture);
cow_bordered_sprite.setScale(5.f,5.f);

cow_harvestable_texture.loadFromFile("coding/gameEngine/gameObjects/assets/cow_harvestable.png");
cow_harvestable_sprite.setTexture(cow_harvestable_texture);
cow_harvestable_sprite.setScale(5.f,5.f);

cow_tile_texture.loadFromFile("coding/gameEngine/gameObjects/assets/cow_tile.png");
cow_tile_sprite.setTexture(cow_tile_texture);
cow_tile_sprite.setScale(5.f,5.f);

cow_texture.loadFromFile("coding/gameEngine/gameObjects/assets/cow.png");
cow_sprite.setTexture(cow_texture);
cow_sprite.setScale(5.f,5.f);

dead_tree_texture.loadFromFile("coding/gameEngine/gameObjects/assets/dead_tree.png");
dead_tree_sprite.setTexture(dead_tree_texture);
dead_tree_sprite.setScale(5.f,5.f);

empty_tile_texture.loadFromFile("coding/gameEngine/gameObjects/assets/empty_tile.png");
empty_tile_sprite.setTexture(empty_tile_texture);
empty_tile_sprite.setScale(5.f,5.f);

pig_bordered_texture.loadFromFile("coding/gameEngine/gameObjects/assets/pig_bordered.png");
pig_bordered_sprite.setTexture(pig_bordered_texture);
pig_bordered_sprite.setScale(5.f,5.f);

pig_tile_texture.loadFromFile("coding/gameEngine/gameObjects/assets/pig_tile.png");
pig_tile_sprite.setTexture(pig_tile_texture);
pig_tile_sprite.setScale(5.f,5.f);

pig_texture.loadFromFile("coding/gameEngine/gameObjects/assets/pig.png");
pig_sprite.setTexture(pig_texture);
pig_sprite.setScale(5.f,5.f);

potato_seed_bordered_texture.loadFromFile("coding/gameEngine/gameObjects/assets/potato_seed_bordered.png");
potato_seed_bordered_sprite.setTexture(potato_seed_bordered_texture);
potato_seed_bordered_sprite.setScale(5.f,5.f);

potato_seed_texture.loadFromFile("coding/gameEngine/gameObjects/assets/potato_seed.png");
potato_seed_sprite.setTexture(potato_seed_texture);
potato_seed_sprite.setScale(5.f,5.f);

potato_tile_grown_texture.loadFromFile("coding/gameEngine/gameObjects/assets/potato_tile_grown.png");
potato_tile_grown_sprite.setTexture(potato_tile_grown_texture);
potato_tile_grown_sprite.setScale(5.f,5.f);

potato_tile_texture.loadFromFile("coding/gameEngine/gameObjects/assets/potato_tile.png");
potato_tile_sprite.setTexture(potato_tile_texture);
potato_tile_sprite.setScale(5.f,5.f);

rain_texture.loadFromFile("coding/gameEngine/gameObjects/assets/rain.png");
rain_sprite.setTexture(rain_texture);
rain_sprite.setScale(5.f,5.f);

shaded_fence_gate_left_texture.loadFromFile("coding/gameEngine/gameObjects/assets/shaded_fence_gate_left.png");
shaded_fence_gate_left_sprite.setTexture(shaded_fence_gate_left_texture);
shaded_fence_gate_left_sprite.setScale(5.f,5.f);

shaded_fence_gate_right_texture.loadFromFile("coding/gameEngine/gameObjects/assets/shaded_fence_gate_right.png");
shaded_fence_gate_right_sprite.setTexture(shaded_fence_gate_right_texture);
shaded_fence_gate_right_sprite.setScale(5.f,5.f);

shaded_fence_texture.loadFromFile("coding/gameEngine/gameObjects/assets/shaded_fence.png");
...
strawberry_seed_bordered_texture.loadFromFile("coding/gameEngine/gameObjects/assets/strawberry_seed_bordered.png");
...
strawberry_seed_texture.loadFromFile("coding/gameEngine/gameObjects/assets/strawberry_seed.png");
strawberry_seed_sprite.setTexture(strawberry_seed_texture);
strawberry_seed_sprite.setScale(5.f,5.f);

strawberry_tile_grown_texture.loadFromFile("coding/gameEngine/gameObjects/assets/strawberry_tile_grown.png");
strawberry_tile_grown_sprite.setTexture(strawberry_tile_grown_texture);
strawberry_tile_grown_sprite.setScale(5.f,5.f);

strawberry_tile_texture.loadFromFile("coding/gameEngine/gameObjects/assets/strawberry_tile.png");
strawberry_tile_sprite.setTexture(strawberry_tile_texture);
strawberry_tile_sprite.setScale(5.f,5.f);

sun1_texture.loadFromFile("coding/gameEngine/gameObjects/assets/sun1.png");
sun1_sprite.setTexture(sun1_texture);
sun1_sprite.setScale(5.f,5.f);

sun2_texture.loadFromFile("coding/gameEngine/gameObjects/assets/sun2.png");
...
void assets::setBaseScreen(GameState gameState, sf::RenderWindow& window) {
    ...
    //plots
        ...
        for (int i = 0; i < 3; i++) { //for 3 horizontal
            for (int j = 0; j < 3; i++) { //for 3 vertical
